...
#define TAG "TaijiPiS3W535cnBoard"


LV_FONT_DECLARE(font_puhui_20_4);
LV_FONT_DECLARE(font_awesome_20_4);

class Axs15231b : public I2cDevice {
public:
    struct TouchPoint_t {
        int num = 0;
        int x = -1;
    ...
    Axs15231b(i2c_master_bus_handle_t i2c_bus, uint8_t addr) : I2cDevice(i2c_bus, addr) {
...
class TaijiPiS3W535cnBoard : public WifiBoard {
private:
    i2c_master_bus_handle_t i2c_bus_;
    Axs15231b* axs15231b_;
    LcdDisplay* display_;
    ...
    static void touchpad_timer_callback(void* arg) {
        auto& board = (TaijiPiS3W535cnBoard&)Board::GetInstance();
    ...
    void InitializeAxs15231bTouchPad() {
        ESP_LOGI(TAG, "Init Axs15231b");
        axs15231b_ = new Axs15231b(i2c_bus_, 0x3B);
    ...
    void InitializeSpi() {
        ...
        // const spi_bus_config_t bus_config = CUST_AXS15231B_PANEL_BUS_QSPI_CONFIG(QSPI_PIN_NUM_LCD_PCLK,
        //       QSPI_PIN_NUM_LCD_DATA0,
        //       QSPI_PIN_NUM_LCD_DATA1,
        //       QSPI_PIN_NUM_LCD_DATA2,
        //       QSPI_PIN_NUM_LCD_DATA3,
        //       320 * 480 * sizeof(uint16_t));
        //     ESP_ERROR_CHECK(spi_bus_initialize(QSPI_LCD_HOST, &bus_config, SPI_DMA_CH_AUTO));

    }

    void InitializestAxs15231bDisplay() {
...
public:
    TaijiPiS3W535cnBoard() {
        InitializeI2c();
        InitializeAxs15231bTouchPad();
        InitializeSpi();
        InitializestAxs15231bDisplay();
        InitializeIot();
        InitializeMute();
    }
    ...
    Axs15231b* GetTouchpad() {
        return axs15231b_;
    }
};

DECLARE_BOARD(TaijiPiS3W535cnBoard);